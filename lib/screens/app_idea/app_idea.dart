...
class AppIdeaScreen extends StatefulWidget {
  static const routeName = 'app_idea_Screen';

  @override
  _AppIdeaScreenState createState() => _AppIdeaScreenState();
}

class _AppIdeaScreenState extends State<AppIdeaScreen> {
  String _appIdea = 'يتم التحميل';
  @override
  void initState() {
    super.initState();
  ...
  fechAppIdea() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          _appIdea = extractData['data']['idea_text'];
        });
      }
    } catch (error) {
      throw error;
